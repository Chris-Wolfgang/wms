...
public static class AuthSettings
{
    ...
    /// </summary>
    public static IReadOnlyList<SettingKey> All { get; } = [LockoutThreshold, LockoutDuration, SessionLifetime, IdleTimeout, Http.WmsCors.AllowedOrigins, IntegrityVerifyInterval, Providers.AuthProviderSettings.Enabled];
}
