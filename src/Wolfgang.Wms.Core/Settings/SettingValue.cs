...
)
{
    ...
    public static SettingValue Create(SettingKey key, SettingScopeRef scope, string? configuredValue, string effectiveValue, string? inheritedFrom, long? rowVersion = null, string? updatedBy = null, DateTimeOffset? updatedAt = null)
    {
