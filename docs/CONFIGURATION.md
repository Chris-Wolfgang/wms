...
On Windows the services and IIS sites carry these keys in their environment (docs/INSTALL-WINDOWS.md); in containers, `compose.yaml` does (docs/CONTAINERS.md).
